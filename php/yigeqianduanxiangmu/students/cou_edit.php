        ...
        <div class="row">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-addon">老师</div>
                        <input type="text"name="teacher" value="<?php echo $data['c_teacher']?>" class="form-control" id="exampleInputAmount" >
                    </div>
                    <div class="input-group">
                        <div class="input-group-addon">课程学分</div>
                        <input type="text"name="credit" value="<?php echo $data['c_credit']?>" class="form-control" id="exampleInputAmount" >
                    </div>
                </div>
